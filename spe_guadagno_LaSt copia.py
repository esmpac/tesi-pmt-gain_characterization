...
def PEDESTAL():               
    ...
    pedestal_data = Path("/swgo/Test/SWGO_Testbench/multiPMT/calibration/batch_2/pedestal_characterisation/2025_04_03/")   
    print(pedestal_data)                     
...
def SPE(pedestal_values):
    ...
    spe_data_long = Path("/swgo/Test/SWGO_Testbench/multiPMT/calibration/batch_2/single_photoelectron/2025_04_03/run_spe_v_1450_thr_40_pol_90_whe_10_8_win_130/")
...
def GUADAGNO():
    ...
    guadagno_data = Path("dati_guadagno/")
